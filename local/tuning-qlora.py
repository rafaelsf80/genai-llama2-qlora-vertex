"""
    Sample code to train a Llama 2 7B model with QLora
    Must run on a T4 GPU or above (f.e. Colab)
"""

#!pip install -q accelerate==0.21.0 peft==0.4.0 bitsandbytes==0.40.2 transformers==4.31.0 trl==0.4.7 datasets==2.14.5
...
training_arguments = TrainingArguments(
    ...
    per_device_train_batch_size=4, # Batch size per GPU for training ERROR PUSE 64 Y ME DIO OOM
